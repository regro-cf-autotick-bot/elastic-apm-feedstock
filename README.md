...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/elastic-apm-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12695&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/elastic-apm-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `elastic-apm` can be installed with:

```
conda install elastic-apm
```

It is possible to list all of the versions of `elastic-apm` available on your platform with:
